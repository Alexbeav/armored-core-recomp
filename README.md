# Armored Core Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/armored-core-recomp/total)](https://github.com/Alexbeav/armored-core-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/armored-core-recomp/latest/total)](https://github.com/Alexbeav/armored-core-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/armored-core-recomp)](https://github.com/Alexbeav/armored-core-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Armored Core** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Armored Core.
...
Zip prefix for CI artifacts: `Armored-Core-Recomp`.
...
The `v0.3.3` source uses `Armored_Core_Recompiled` in CMake, the setup relaunch, and the packager.
