...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "armored-core-",
    .project_root_env = "ARMORED_CORE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "ARMORED_CORE_RECOMP_BUILD_DIR",
    .force_setup_env = "ARMORED_CORE_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_008.42_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "armored_core__Recompiled",
    .prepare_note =
