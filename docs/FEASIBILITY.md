# Armored Core release feasibility
...
The supported serial set is $(@{ordinal=6; slug=armored-core; title=Armored Core; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
