# Armored Core knowledge report

- Date: 2026-08-31
- Retail identity: Europe PAL `SCES-00842`
...
The source now uses `Armored_Core_Recompiled` as the only setup executable name. The batch source
